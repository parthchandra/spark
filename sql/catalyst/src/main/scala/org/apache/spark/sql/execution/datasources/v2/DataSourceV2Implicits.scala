...
import org.apache.spark.sql.connector.catalog.{MetadataColumn, SupportsAtomicPartitionManagement, SupportsDelete, SupportsMerge, SupportsPartitionManagement, SupportsRead, SupportsWrite, Table, TableCapability}
