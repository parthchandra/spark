...
## Summary
  - Number of queries: 329
  - Number of expressions that missing example: 35
  - Expressions missing examples: and,string,tinyint,double,smallint,date,decimal,boolean,float,binary,bigint,int,timestamp,struct,cume_dist,dense_rank,input_file_block_length,input_file_block_start,input_file_name,lag,lead,monotonically_increasing_id,ntile,!,not,or,percent_rank,rank,row_number,session_window,spark_partition_id,version,window,positive,count_min_sketch
